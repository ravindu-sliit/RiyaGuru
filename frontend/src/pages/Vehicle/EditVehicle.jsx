  ...
  const fetchVehicle = async () => {
    try {
      ...
      setFormData({
        ...
        status: vehicle.status || "Not-Active",
        lastServiceDate: vehicle.lastServiceDate
          ? vehicle.lastServiceDate.split("T")[0]
          : "",
        nextServiceDue: vehicle.nextServiceDue
          ? vehicle.nextServiceDue.split("T")[0]
          : "",
        image: null,
      });

      if (vehicle.image) {
        setImagePreview(`http://localhost:5000${vehicle.image}`);
      }
    } catch (error) {
  ...
  if (initialLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-10 text-gray-500">
        ...
        <p className="mt-3 text-sm">Loading vehicle details...</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">Update vehicle information</p>
        </div>
      </div>
