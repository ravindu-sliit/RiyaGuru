        ...
        <div className="text-center py-10 text-gray-500">
          ...
          <div className="flex justify-center gap-3">
            {vehicles.length === 0 && (
              <Link 
                to="/vehicles/add" 
                className="inline-flex items-center gap-2 bg-orange-500 text-white px-4 py-2 rounded-md shadow-sm hover:bg-orange-600 transition"
              >
                <Plus size={18} /> Add First Vehicle
              </Link>
            )}
